 ...
 */
class Musica extends \Application\Entity\Musica implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Musica' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Musica' . "\0" . 'nome', '' . "\0" . 'Application\\Entity\\Musica' . "\0" . 'album', '' . "\0" . 'Application\\Entity\\Musica' . "\0" . 'genero'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Musica $proxy) {
